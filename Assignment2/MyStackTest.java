...
public class MyStackTest {
	...
	@Test
	public void testPopStudent() throws Exception{
		//Use the doubleQ for student tests
		assertEquals(Double.valueOf(5.0), doubleS.pop());
	...
	public void testPushStudent() throws StackOverflowException{
		...
		assertEquals(true, doubleS.push(6.0));
	...
	public void testToStringStudent() throws StackOverflowException{
		//Use the doubleQ for student tests
		assertEquals("4.02.05.0", doubleS.toString());
		assertEquals(true, doubleS.push(2));
		assertEquals("4.02.05.02", doubleS.toString());
