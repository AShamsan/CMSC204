...
public class MyQueueTest {
	...
	public void setUp() throws Exception {
		...
		doubleQ.enqueue(40.0);
		doubleQ.enqueue(20.0);
		doubleQ.enqueue(50.0);
	}
	...
	public void testDequeueStudent() throws QueueUnderflowException{
		...
		assertEquals(Double.valueOf(40.0), doubleQ.dequeue());
		assertEquals(Double.valueOf(20.0), doubleQ.dequeue());
		assertEquals(Double.valueOf(50.0), doubleQ.dequeue());
	...
	public void testEnqueueStudent() throws QueueOverflowException{
		//Use the doubleQ for student tests
				...
				assertEquals(true, doubleQ.enqueue(55));
	...
	public void testToStringStudent() {
		//Use the doubleQ for student tests
		//Use the doubleQ for student tests
		assertEquals("40.020.050.0", doubleQ.toString());
	}
